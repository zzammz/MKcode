...
def generate_full_name (first_name, last_name):
    space = ' '
      full_name = first_name + space + last_name
      return full_name
print('Full Name: ', generate_full_name('Jim','Halpert'))
...
def print_fullname(firstname, lastname):
    ...
    print(full_name)
print(print_fullname(firstname = 'Jim', lastname = 'Halpert'))
...
def print_full_name(firstname, lastname):
    ...
    full_name = firstname  + space + lastname
    return full_name
print_full_name(firstname='Jim', lastname='Halpert')
```
...
def generate_full_name (first_name = 'Jim', last_name = 'Halpert'):
    space = ' '
    full_name = first_name + space + last_name
    return full_name
...
def generate_groups (team,*args):
    ...
    for i in args:
        print(i)
print(generate_groups('Team-1','Jim','Oscar','Pam','Michael'))
```
