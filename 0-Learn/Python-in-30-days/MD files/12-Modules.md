...
# main.py file
import mymodule
print(mymodule.generate_full_name('Jim', 'Halpert')) # Jim Halpert
```
...
print(generate_full_name('Jim','Halpert'))
...
```sh
python script.py Jim 30DaysOfPython
```

The result:

```sh
Welcome Jim. Enjoy  30DayOfPython challenge! 
```
