...
```sh
mongodb+srv://jim:<password>@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority
```
...
```sh
mongodb+srv://jim:123123123@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority
```
...
MONGODB_URI = 'mongodb+srv://jim:your_password_goes_here@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority'
...
db.students.insert_one({'name': 'jim', 'country': 'Finland', 'city': 'Helsinki', 'age': 250})
print(client.list_database_names())
...
```sh
{'_id': ObjectId('5df68a21f106fe2d315bbc8b'), 'name': 'Jim', 'country': 'US', 'city': 'Scranton', 'age': 250}
```
...
The first person, Jim got a very implausible age. Let us update Jim's age.
...
```sh
{'_id': ObjectId('5df68a21f106fe2d315bbc8b'), 'name': 'Jim', 'country': 'US', 'city': 'Scranton', 'age': 38}
{'_id': ObjectId('5df68a23f106fe2d315bbc8c'), 'name': 'David', 'country': 'UK', 'city': 'London', 'age': 34}
{'_id': ObjectId('5df68a23f106fe2d315bbc8d'), 'name': 'John', 'country': 'Sweden', 'city': 'Stockholm', 'age': 28}
{'_id': ObjectId('5df68a23f106fe2d315bbc8e'), 'name': 'Sami', 'country': 'Finland', 'city': 'Helsinki', 'age': 25}
```
